...
export const SUPPORTED_MODELS: AIModel[] = [
  ...
  // ----------------------------------------------------
  {
    ...
    description: 'Lightweight ultra-low cost Gemini 2.5 Flash variant ($0.10/1M in · $0.40/1M out).',
  ...
  },
  {
    ...
    contextWindow: 1048576,
    description: 'Next-gen Gemini 3.5 Flash Lite model ($0.30/1M in · $2.50/1M out).',
  ...
  },
  {
    ...
    outputCostPer1M: 2.50,
    contextWindow: 1048576,
    description: 'Official Google AI Gemini 2.5 Flash model ($0.30/1M in · $2.50/1M out).',
  ...
  },
  {
    ...
    outputCostPer1M: 2.50,
    contextWindow: 1048576,
    description: 'Official GCP Vertex AI Gemini 3.5 Flash Lite ($0.30/1M in · $2.50/1M out).',
    defaultSimulatedLatencyMs: 290,
    accuracyMultiplier: 96,
  },
  {
  ...
  // ----------------------------------------------------
  {
    ...
    contextWindow: 128000,
    description: 'Ultra-fast, cost-efficient GPT-5.4 nano model deployed on Azure AI Foundry.',
  ...
  },
  {
    ...
    badgeColor: 'bg-cyan-500/10 text-cyan-400 border-cyan-500/30',
    inputCostPer1M: 0.18,
    outputCostPer1M: 0.72,
    contextWindow: 128000,
    description: 'Next-generation Azure GPT-5 mini model for fast and intelligent text generation.',
    defaultSimulatedLatencyMs: 400,
    accuracyMultiplier: 97,
  },
  {
    id: 'azure-grok-4-1-fast-non-reasoning',
    name: 'Azure Grok-4-1-fast-non-reasoning',
    provider: 'azure',
    providerName: 'Microsoft Azure AI',
    badgeColor: 'bg-cyan-500/10 text-cyan-400 border-cyan-500/30',
    inputCostPer1M: 0.20,
    ...
    contextWindow: 128000,
    description: 'Grok-4-1-fast-non-reasoning model deployed on Azure AI Foundry.',
    defaultSimulatedLatencyMs: 350,
    accuracyMultiplier: 95,
  },
